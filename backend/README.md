...
## Project Structure
    ...
    ├── tstdasdoinsdsdacs__117292  # Django project configurations
...
1. Clone this repo and `cd tstdasdoinsdsdacs__117292`
...
2. Clone this repo and `cd tstdasdoinsdsdacs__117292`
